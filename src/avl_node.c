...
avl_node_t *avl_node_init(void *data) {
    avl_node_t *node;
...
int avl_node_insert(avl_node_t **p_node, cmp_t *cmp, avl_node_t *node) {
...
int avl_node_pick_rightmost(avl_node_t **p_node, avl_node_t **picked) {
...
void *avl_node_search(avl_node_t *node, cmp_t *cmp, void *data) {
...
void avl_node_rot(avl_node_t **p_node, char dir) {
    int d_idx, c_idx;
    avl_node_t *tmp;
...
int avl_node_rebalance(avl_node_t **p_node) {
    avl_node_t *node = *p_node;
...
/* This is pretty inefficient right now - a LOT of string copying.
   ...
   all that much */
char *avl_node_str(avl_node_t *node, str_t *str) {
    int idx, jdx;
...
void avl_node_free(avl_node_t *node, int recurse) {
